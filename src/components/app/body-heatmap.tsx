...
const REGIONS: Region[] = [
  // FRONT
  { id: "shoulders", label: "Shoulders", side: "front", d: "M28 48 Q28 38 38 36 L42 44 L36 56 Z M72 48 Q72 38 62 36 L58 44 L64 56 Z" },
  { id: "chest", label: "Chest", side: "front", d: "M38 50 Q50 46 62 50 L62 70 Q50 76 38 70 Z" },
  { id: "biceps", label: "Biceps", side: "front", d: "M26 60 L34 58 L34 80 L26 82 Z M74 60 L66 58 L66 80 L74 82 Z" },
  { id: "core", label: "Core", side: "front", d: "M40 72 L60 72 L60 100 L40 100 Z" },
  { id: "quads", label: "Quads", side: "front", d: "M38 108 L48 108 L46 152 L38 150 Z M62 108 L52 108 L54 152 L62 150 Z" },
  { id: "calves", label: "Calves", side: "front", d: "M40 162 L46 162 L46 188 L40 186 Z M54 162 L60 162 L60 186 L54 188 Z" },
  // BACK
  { id: "back", label: "Back", side: "back", d: "M36 50 Q50 46 64 50 L64 96 Q50 100 36 96 Z" },
  { id: "triceps", label: "Triceps", side: "back", d: "M26 60 L34 58 L34 82 L26 84 Z M74 60 L66 58 L66 82 L74 84 Z" },
  { id: "shoulders-back", label: "Rear Delts", side: "back", d: "M28 48 Q28 38 38 36 L42 44 L36 54 Z M72 48 Q72 38 62 36 L58 44 L64 54 Z" },
  { id: "glutes", label: "Glutes", side: "back", d: "M38 100 L62 100 L62 124 Q50 128 38 124 Z" },
  { id: "hamstrings", label: "Hamstrings", side: "back", d: "M38 128 L48 128 L46 158 L38 156 Z M62 128 L52 128 L54 158 L62 156 Z" },
  { id: "calves-back", label: "Calves", side: "back", d: "M40 162 L46 162 L46 188 L40 186 Z M54 162 L60 162 L60 186 L54 188 Z" },
];
...
export function BodyHeatmap({
  values, mode, onSelect, compact, side: forcedSide,
}: {
