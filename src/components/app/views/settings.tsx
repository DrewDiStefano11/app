      ...
      <div className="px-5 space-y-5">
        <section className="space-y-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1 mb-2">
              Manage your AI permissions, memory, and training targets.
            </p>
          </div>
        ...
        <section>
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1 mb-2">
              Adjust your biometrics and experience level to calibrate training suggestions.
            </p>
          </div>
          <Card className="space-y-4">
            <div>
              ...
              <Select
                ...
                onChange={(e) => updateProfile({ goal: e.target.value as Profile["goal"] })}
              >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateProfile({ daysPerWeek: Number(e.target.value) || 0 })}
                />
              </div>
              <div>
                <Label>Split</Label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateProfile({ bodyweightLb: Number(e.target.value) || 0 })}
                />
              </div>
              <div>
                ...
                <Input
                  inputMode="decimal"
                  value={state.profile.targetBodyweightLb}
                  onChange={(e) =>
                    updateProfile({ targetBodyweightLb: Number(e.target.value) || 0 })
                  }
                />
              </div>
            </div>
            ...
            {(["workout", "weighIn", "lunch"] as const).map((k) => (
              <label key={k} className="flex items-center justify-between py-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    set((s) => ({ ...s, reminders: { ...s.reminders, [k]: e.target.checked } }))
                  }
        ...
        <section>
          ...
          <Card className="space-y-3">
            <div className="grid grid-cols-2 gap-2">
              <GhostButton className="justify-center" onClick={downloadBackup}>
                <Download size={16} />
                Export
              </GhostButton>
              <label>
            ...
            <button
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-destructive text-destructive font-medium flex items-center justify-center gap-2"
            >
              <Trash2 size={16} />
              Reset all data
            </button>
        ...
        <section>
          ...
          <Card>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              ...
              <span className="font-medium text-foreground">Data stays on this device.</span> No
