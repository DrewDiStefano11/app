        ...
        <section>
          ...
          <Card className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground pt-2">
              Reminders use browser notifications when granted. The app works without them.
            </p>
          </Card>
        </section>
            ...
            <label className="flex items-center justify-between py-1">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Fills charts and dashboards with sample workouts, meals, sleep and PRs. Your real
                  data is preserved.
                </p>
              </div>
              <input
        ...
        <section>
          ...
          <Card>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              AI coach: Lovable AI (Gemini). Data stays on this device. No accounts, no tracking.
            </p>
          </Card>
        </section>
      </div>
