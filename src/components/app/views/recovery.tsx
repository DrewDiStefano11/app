...
export function RecoveryView() {
  ...
  return (
    <div className="pb-24">
      <PageHeader
        title="Recovery"
        subtitle={parts ? `Readiness ${score}%` : "Add a check-in to start"}
      />
...
function ReadinessTab() {
  ...
  const rec = !parts
    ? "Log sleep or a daily check-in to generate your readiness score."
    : score >= 75
    ...
    <div className="px-5">
      <div className="card-elev p-5 section-gradient ring-section">
        ...
        <div className="flex gap-2 mt-4">
          ...
          <GhostButton aria-label="Log sleep" onClick={() => setSleepOpen(true)}>
            <Moon size={16} />
            Sleep
          </GhostButton>
        </div>
      ...
      <p className="text-[11px] text-muted-foreground text-center mt-4">
        General fitness guidance only. This app does not diagnose, treat, or detect medical
        conditions.
      </p>
  ...
  return (
    <div className="px-5">
      ...
      <SectionHeader
        ...
        action={
          <button
            onClick={() => setFatigueOpen(true)}
            aria-label="Update all muscle fatigue"
      ...
      {sore.length === 0 ? (
        <Card>
          <p className="text-sm text-muted-foreground">
            All muscles marked fresh. Tap 'Update all' or use quick tap below if you feel sore.
          </p>
        </Card>
      ) : (
        <Card>
      ...
      <SectionHeader title="Quick tap to update" />
    ...
    <div className="px-5">
      ...
      {checks.length === 0 ? (
        <EmptyState
          icon={<Heart size={22} />}
          title="No check-ins"
          description="Log daily check-ins to see your readiness curve."
        />
      ) : (
