...
import { Play, Plus, Clock, Flame, Trash2, Activity, Trophy, Layout } from "lucide-react";
    ...
    <div className="px-5">
      <div className="card-elev p-5 section-gradient ring-section">
        ...
        <div className="flex gap-2 mt-4">
          <PrimaryButton
            onClick={planExercises ? startPlan : () => onJump("workouts")}
            className="flex-1"
          >
            <Play size={16} />
...
function PerformanceTab() {
    ...
    return (
      <div className="px-5">
        <EmptyState
          ...
          description="Complete your first workout to see volume trends and muscle balance."
        />
      </div>
    );
  }
  ...
  return (
    <div className="px-5">
      ...
      <Card onClick={() => setVolumeOpen(true)}>
        {total14 === 0 ? (
      ...
      <VolumeDetailSheet open={volumeOpen} onClose={() => setVolumeOpen(false)} />
    </div>
  );
}
