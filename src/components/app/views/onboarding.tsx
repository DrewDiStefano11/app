...
export function Onboarding() {
  ...
  const finish = () =>
    set((s) => ({ ...s, profile, nutritionTargets: targets, onboardingComplete: true }));
      ...
      <div className="flex gap-1 mb-8">
        {STEPS.map((_, i) => (
          <div
            ...
            style={{ background: i <= step ? "var(--section)" : "var(--surface-2)" }}
          />
        ))}
      </div>
        ...
        {current === "welcome" && (
          <div className="text-center my-auto">
            ...
            <p className="text-muted-foreground mt-3 max-w-sm mx-auto">
              Your personal command center for training, nutrition, recovery and progress.
            </p>
          </div>
        )}
        ...
        {current === "goal" && (
          <div className="space-y-4">
            ...
            <Select
              value={profile.goal}
              onChange={(e) =>
                setProfile((p) => ({ ...p, goal: e.target.value as Profile["goal"] }))
              }
            >
        ...
        {current === "experience" && (
          <div className="space-y-4">
            ...
            <Select
              ...
              onChange={(e) =>
                setProfile((p) => ({ ...p, experience: e.target.value as Profile["experience"] }))
              }
            >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile((p) => ({ ...p, daysPerWeek: Number(e.target.value) || 0 }))
                }
              />
            </div>
            <div>
              ...
              <Select
                value={profile.split}
                onChange={(e) => setProfile((p) => ({ ...p, split: e.target.value }))}
              >
        ...
        {current === "weight" && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label>Current (lb)</Label>
                <Input
                  inputMode="decimal"
                  value={profile.bodyweightLb}
                  onChange={(e) =>
                    setProfile((p) => ({ ...p, bodyweightLb: Number(e.target.value) || 0 }))
                  }
                />
              </div>
              <div>
                ...
                <Input
                  inputMode="decimal"
                  value={profile.targetBodyweightLb}
                  onChange={(e) =>
                    setProfile((p) => ({ ...p, targetBodyweightLb: Number(e.target.value) || 0 }))
                  }
                />
              </div>
            </div>
        ...
        {current === "macros" && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Defaults work for most lifters. Edit anytime.
            </p>
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setTargets((t) => ({ ...t, calories: +e.target.value || 0 }))}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setTargets((t) => ({ ...t, protein: +e.target.value || 0 }))}
                />
              </div>
              <div>
                <Label>Carbs (g)</Label>
                <Input
                  inputMode="numeric"
                  value={targets.carbs}
                  onChange={(e) => setTargets((t) => ({ ...t, carbs: +e.target.value || 0 }))}
                />
              </div>
              <div>
                <Label>Fat (g)</Label>
                <Input
                  inputMode="numeric"
                  value={targets.fat}
                  onChange={(e) => setTargets((t) => ({ ...t, fat: +e.target.value || 0 }))}
                />
              </div>
            </div>
          </div>
        ...
        {current === "done" && (
          <div className="text-center my-auto">
            ...
            <p className="text-muted-foreground mt-3">
              Open the app, start a workout, log a meal, and your floating AI coach is one tap away.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="flex gap-2 mt-8">
        ...
        {current !== "done" ? (
          <PrimaryButton className="flex-1" onClick={next}>
            {current === "welcome" ? "Get started" : "Continue"}
          </PrimaryButton>
        ) : (
