...
const ex = (
  id: string, name: string, primary: MuscleGroup[], equipment: string,
  category: Exercise["category"] = "compound", defaultSets = 3, defaultReps = "8-12",
  secondary: MuscleGroup[] = [], cues: string[] = []
): Exercise => ({ id, name, primary, secondary, equipment, category, defaultSets, defaultReps, cues });

export const EXERCISES: Exercise[] = [
  // Chest
  ex("bench-press", "Barbell Bench Press", ["chest"], "barbell", "compound", 4, "5-8", ["triceps","shoulders"], ["Plant feet", "Squeeze shoulder blades", "Bar to lower chest"]),
  ex("db-bench", "Dumbbell Bench Press", ["chest"], "dumbbell", "compound", 3, "8-12", ["triceps","shoulders"]),
  ex("incline-db", "Incline Dumbbell Press", ["chest"], "dumbbell", "compound", 3, "8-12", ["shoulders"]),
  ...
  ex("trap-bar-dl", "Trap Bar Deadlift", ["back","quads","glutes"], "barbell", "compound", 3, "5-8"),
...
export interface TemplateExercise { exerciseId: string; sets: number; reps: string; rest?: number; notes?: string }
export interface WorkoutTemplate {
  id: string; name: string; goal: string; durationMin: number;
  exercises: TemplateExercise[]; notes?: string;
}

const T = (id: string, name: string, goal: string, durationMin: number, exercises: TemplateExercise[]): WorkoutTemplate =>
  ({ id, name, goal, durationMin, exercises });
const e = (exerciseId: string, sets = 3, reps = "8-12", rest = 90): TemplateExercise => ({ exerciseId, sets, reps, rest });

export const WORKOUT_TEMPLATES: WorkoutTemplate[] = [
  T("push", "Push Day", "Hypertrophy", 60, [
    e("bench-press", 4, "5-8", 150), e("incline-db", 3, "8-12"), e("machine-press", 3, "10-12"),
    e("lat-raise", 3, "12-15", 60), e("tri-pushdown", 3, "10-15", 60), e("oh-tri", 3, "10-12", 60),
  ]),
  T("pull", "Pull Day", "Hypertrophy", 60, [
    e("pullup", 4, "6-10", 120), e("barbell-row", 4, "6-10", 120), e("cable-row", 3, "10-12"),
    e("face-pull", 3, "12-15", 60), e("bb-curl", 3, "8-12", 60), e("hammer-curl", 3, "10-12", 60),
  ]),
  T("legs", "Legs Day", "Strength + Hypertrophy", 70, [
    e("squat", 4, "5-8", 180), e("rdl", 3, "8-12", 120), e("leg-press", 3, "10-15"),
    e("lying-curl", 3, "10-15", 60), e("leg-ext", 3, "12-15", 60), e("standing-calf", 4, "10-15", 60),
  ]),
  T("upper", "Upper Body", "Hypertrophy", 60, [
    e("bench-press", 4, "6-8"), e("barbell-row", 4, "6-8"), e("db-shoulder", 3, "8-12"),
    e("lat-pulldown", 3, "10-12"), e("bb-curl", 3, "10-12", 60), e("tri-pushdown", 3, "10-15", 60),
  ]),
  T("lower", "Lower Body", "Strength", 60, [
    e("squat", 4, "5-8", 180), e("rdl", 3, "8-10", 120), e("bss", 3, "8-10"),
    e("seated-curl", 3, "10-15", 60), e("standing-calf", 4, "10-15", 60),
  ]),
  T("full", "Full Body", "General", 60, [
    e("squat", 3, "5-8"), e("bench-press", 3, "5-8"), e("barbell-row", 3, "6-10"),
    e("db-shoulder", 3, "8-12"), e("plank", 3, "45s", 30),
  ]),
  T("beginner3", "Beginner 3-Day", "General Strength", 45, [
    e("squat", 3, "5"), e("bench-press", 3, "5"), e("barbell-row", 3, "5"),
  ]),
  T("strength4", "Strength Focus 4-Day", "Strength", 65, [
    e("squat", 5, "5"), e("bench-press", 5, "5"), e("deadlift", 3, "3"), e("ohp", 4, "5"),
  ]),
  T("hyper5", "Hypertrophy 5-Day", "Hypertrophy", 60, [
    e("incline-db", 4, "8-12"), e("cable-fly", 3, "12-15"), e("lat-raise", 4, "12-15", 60),
    e("tri-pushdown", 3, "10-15", 60), e("oh-tri", 3, "10-12", 60),
  ]),
  T("deload", "Deload Day", "Recovery", 40, [
    e("bench-press", 3, "5", 120), e("squat", 3, "5", 120), e("cable-row", 3, "10"),
  ]),
];

export interface Food {
  id: string; name: string; category: string;
  servingLabel: string; calories: number;
  protein: number; carbs: number; fat: number; fiber?: number;
}
const f = (id: string, name: string, category: string, servingLabel: string,
  calories: number, p: number, c: number, fat: number, fiber = 0): Food =>
  ({ id, name, category, servingLabel, calories, protein: p, carbs: c, fat, fiber });
...
export interface MealTemplateItem { foodId: string; servings: number }
...
export const MEAL_TEMPLATES: MealTemplate[] = [
  mt("lean-oats","Lean Protein Oats","breakfast",[{foodId:"oats",servings:1},{foodId:"whey",servings:1},{foodId:"blueberries",servings:1}]),
  mt("bagel-eggs","Muscle Building Bagel & Eggs","breakfast",[{foodId:"bagel",servings:1},{foodId:"whole-egg",servings:2},{foodId:"egg-white",servings:1}]),
  mt("turkey-wrap","Turkey & Avocado Wrap","lunch",[{foodId:"ground-turkey",servings:1},{foodId:"ww-bread",servings:1},{foodId:"avocado",servings:1}]),
  mt("classic","Classic Chicken Rice Broccoli","dinner",[{foodId:"chicken-breast",servings:1},{foodId:"white-rice",servings:1},{foodId:"broccoli",servings:1}]),
  mt("salmon-sp","Salmon & Sweet Potato","dinner",[{foodId:"salmon",servings:1},{foodId:"sweet-potato",servings:1},{foodId:"asparagus",servings:1}]),
  mt("turkey-pasta","Turkey Marinara Pasta","dinner",[{foodId:"ground-turkey",servings:1},{foodId:"pasta",servings:1}]),
  mt("yogurt-bowl","Greek Yogurt Bowl","snack",[{foodId:"greek-yogurt",servings:1},{foodId:"strawberries",servings:1},{foodId:"almonds",servings:1}]),
  mt("pre-carbs","Pre-Training Carb Load","pre-workout",[{foodId:"oats",servings:1},{foodId:"banana",servings:1},{foodId:"honey",servings:1}]),
  mt("post-chicken","Post-Workout Chicken & Potatoes","post-workout",[{foodId:"chicken-breast",servings:1},{foodId:"white-potato",servings:1}]),
  mt("cottage-night","Cottage Cheese Night Snack","snack",[{foodId:"cottage",servings:1},{foodId:"pb",servings:1}]),
  mt("tuna-lunch","Tuna Work Lunch","lunch",[{foodId:"tuna",servings:1},{foodId:"ww-bread",servings:1},{foodId:"apple",servings:1}]),
  mt("chickpea-quinoa","Chickpea Quinoa Salad","lunch",[{foodId:"chickpeas",servings:1},{foodId:"quinoa",servings:1},{foodId:"spinach",servings:1}]),
  mt("steak-pot","Steak & Potatoes","dinner",[{foodId:"sirloin",servings:1},{foodId:"white-potato",servings:1},{foodId:"green-beans",servings:1}]),
  mt("smoothie","Berry Recovery Smoothie","post-workout",[{foodId:"whey",servings:1},{foodId:"blueberries",servings:1},{foodId:"banana",servings:1},{foodId:"skim-milk",servings:1}]),
  mt("omelet","Veggie Omelet","breakfast",[{foodId:"whole-egg",servings:1},{foodId:"egg-white",servings:1},{foodId:"spinach",servings:1},{foodId:"cheese",servings:1}]),
];
