...
test.describe('App Smoke Test', () => {
  ...
  test('should load the app and complete onboarding', async ({ page }) => {
    ...
    await expect(page.getByText('FitCore Today', { exact: true }).or(page.getByText('FitCore Score'))).toBeVisible({ timeout: 10000 });
  });
  ...
  test('should render AI launcher', async ({ page }) => {
    ...
    const aiLauncher = page.locator('button').filter({ hasText: /Readiness is|AI COACH|Log your first/ });
