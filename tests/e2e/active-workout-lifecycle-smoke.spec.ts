...
test.describe('Active Workout Lifecycle Smoke', () => {
  ...
  test('scenario coverage for creating, adding exercises, and saving a workout', async ({ page }) => {
    ...
    const exerciseBtn = page.locator('.sheet-surface').getByRole('button', { name: /Squat/i }).first();
