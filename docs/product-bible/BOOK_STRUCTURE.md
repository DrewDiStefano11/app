...
| Book 7  | [Recovery, Sleep and Wearables](./book-07-recovery-sleep-and-wearables/README.md)                                     | Defines recovery check-ins, sleep intelligence, Apple Health, Apple Watch, Fitbit, WHOOP/Noop, future Garmin/Oura, sensors, readiness, and environmental context.                      | Recovery and integration strategy.                     |
| Book 8  | [Medical, Genetics and Precision Health](./book-08-medical-genetics-and-precision-health/README.md)                   | Defines medical records, labs, imaging, medications, allergies, conditions, safety boundaries, red flags, sensitive data controls, and future precision health inputs.                 | Medical data, genetics, and AI safety.                 |
| Book 9  | [Analytics, Insights and Health Twin](./book-09-analytics-insights-and-health-twin/README.md)                         | Defines dashboards, graph explanations, long-term memory, simulations, Health Biography, Health Twin, Personal Operating Manual, and alternate futures.                                | Long-term intelligence.                                |
| Book 10 | [Testing, QA and Platform Engineering](./book-10-testing-qa-and-platform-engineering/README.md)                       | Defines automated testing, manual QA, visual regression, accessibility, performance, release safety, CI, agent coordination, and platform operations.                                  | Quality and engineering operations.                    |
...
- Put domain-specific feature specifications in Books 6 through 9. (Note: Book 8 owns medical safety, genetics, precision health, and sensitive data controls; but it does not own training programming, macro logic, or general recovery logic).
